...
class Command_help(commands.Cog):
    ...
    async def _command_help(self, ctx):
    ...
    @cmd.command(name='administration', aliases=['admin'])
    ...
    @cmd.command(name='moderation', aliases=['mod'])
    ...
    @cmd.command(name='images', aliases=['img'])
    @commands.has_guild_permissions(send_messages=True)
    ...
    @cmd.command(name='social', aliases=['soc'])
    @commands.has_guild_permissions(send_messages=True)
    ...
    @cmd.command(name='utility', aliases=['util'])
    @commands.has_guild_permissions(send_messages=True)
